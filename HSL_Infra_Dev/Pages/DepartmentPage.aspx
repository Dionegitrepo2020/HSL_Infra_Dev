                ...
                <div class="row">
                    <div class="container-fluid">
                        <asp:GridView ID="grdvCrudOperation" runat="server" HorizontalAlign="Center"
                            ...
                            <EmptyDataTemplate>THERE ARE NO BOMS CREATED YET</EmptyDataTemplate>
                        </asp:GridView>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                <div class="row m-3">
                                    ...
                                    <asp:TextBox ID="txt_DeptId" class="form-control-range w-50 rounded-0" ReadOnly="true" runat="server" />
                                </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" CssClass="btn btn-primary" Text="Update" ID="btnUpdate" />
                        </div>
                    </div>
                </div>
            </div>
