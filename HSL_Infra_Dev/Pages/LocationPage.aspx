                    ...
                    <div class="container-fluid">
                        <asp:GridView ID="grdvCrudOperation" runat="server" HorizontalAlign="Center" OnRowDataBound="grdvCrudOperation_RowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="LOCATION_DESC" HeaderText="LOCATION DESCRIPTION" />
                            ...
                            <EmptyDataTemplate>THERE ARE NO LOCATIONS CREATED YET</EmptyDataTemplate>
                        </asp:GridView>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                <div class="row m-3">
                                    <label for="txtlocid" class="w-50 text-right">Location ID: &nbsp</label>
                                    <asp:TextBox ID="txt_Locationid" class="form-control-range w-50 rounded-0" runat="server" />
                                </div>

                                <div class="row m-3">
                                    <label for="txtlocdesc" class="w-50 text-right">Location Description: &nbsp</label>
                                    <asp:TextBox ID="txt_loationdesc" class="form-control-range w-50 rounded-0" runat="server" />
                                </div>
