<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/SideBarMaster.Master" AutoEventWireup="true" CodeBehind="UsersPage.aspx.cs" Inherits="HSL_Infra_Dev.Pages.UsersPage" %>
    ...
    <body class="bg-light">
        <form runat="server">
            <div class="container-fluid shadow bg-white">
                <div class="row">
                    <h5 class="col align-items-centert m-1">USER MASTER</h5>
                ...
                <div class="row">
                    <div class="container-fluid">
                        <asp:GridView ID="grdvCrudOperation" runat="server" HorizontalAlign="Center"
                            ...
                            <EmptyDataTemplate>THERE ARE NO USERS CREATED YET</EmptyDataTemplate>
                        </asp:GridView>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                <div class="row m-3">
                                    <label for="txtuserid" class="w-50 text-right">User ID: &nbsp</label>
                                    <asp:TextBox ID="txt_UserId" class="form-control-range w-50 rounded-0" runat="server" />
                                </div>

                                <div class="row m-3">
                                    <label for="txusername" class="w-50 text-right">User Name: &nbsp</label>
                                    <asp:TextBox ID="txt_UserName" class="form-control-range w-50 rounded-0" runat="server" />
                                </div>

                                <div class="row m-3">
                                    <label for="txuserpass" class="w-50 text-right">User Password: &nbsp</label>
                                    <asp:TextBox ID="txt_UserPass" class="form-control-range w-50 rounded-0" runat="server" />
                                </div>
                                ...
                                <div class="row m-3">
                                    <label for="txtrole" class="w-50 text-right">Role: &nbsp</label>
                                    <asp:TextBox ID="txt_Role" class="form-control-range w-50 rounded-0" runat="server" />
                                </div>
